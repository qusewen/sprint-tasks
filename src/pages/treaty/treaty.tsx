...
export const Treaty =()=> (
  ...
  <div className="treaty"  >
    <div className="container treaty-container">
    <div className='active_bur'><Navigation/> </div>
      <div className="treaty__information">
      <h2 className="rules__information_title">Договор оферты</h2>
        <ol className='rules__list'>
          <li className='rules__list_item'>
            <li className='rules__list_item-title'>
            ...
            <ol className='rules__list_second'>
              <li className='rules__list_second-item'>
          ...
          <li className='rules__list_item'>
            ...
            <ol className='rules__list_second'>
              ...
              <li className='rules__list_second-item'>
                <ol className='rules__list_therd'>
                  <li className='rules__list_therd-item'>
              ...
              <li className='rules__list_second-item'>
                ...
                <ol className='rules__list_therd'>
                  <li className='rules__list_therd-item'>
                    ...
                    <ol className='rules__list_for'>
                      <li className='rules__list_for-item'>
